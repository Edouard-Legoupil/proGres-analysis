#' @name recode_registration
#' @rdname recode_registration
#' @title  Recode registration data from UNHCR proGres database and generate a summary report.
#'
#' @description Performs a series of cleaning   
#'
#'
#' @return save a cleaned csv file within the data folder.
#'
#' @export recode_registration
#'
...
recode_registration <- function() {



cat("Loading table containing information")
progres.case <- readr::read_csv(paste0(getwd(),"/data-raw/caseprofile.csv")) 
progres.specificneed <- readr::read_csv(paste0(getwd(),"/data-raw/caseprofileneeds.csv")) 

SpecificNeedsCodesV2 <- readxl::read_excel(paste0(getwd(),"/data-raw/SpecificNeedsCodesV2.xlsx"),
                                           sheet = "Revised")
...
readr::write_csv(progres.case.sp, file = "data-raw/progrescase-1.csv")
